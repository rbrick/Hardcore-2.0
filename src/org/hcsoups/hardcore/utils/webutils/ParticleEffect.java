package org.hcsoups.hardcore.utils.webutils;
...
public enum ParticleEffect {
	 ...
	 */
	public void display(Vector direction) throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
		display(direction, (float) 3, direction.toLocation(Bukkit.getWorld("world")), Arrays.asList(Bukkit.getOnlinePlayers()));
	}
	...
	public static final class ParticlePacket {
		...
		public static void initialize() throws VersionIncompatibleException {
			...
			try {
				version = Integer.parseInt(Character.toString(org.hcsoups.hardcore.utils.webutils.ReflectionUtils.PackageType.getServerVersion().charAt(3)));
				if (version > 7) {
					enumParticle = org.hcsoups.hardcore.utils.webutils.ReflectionUtils.PackageType.MINECRAFT_SERVER.getClass("EnumParticle");
				}
				Class<?> packetClass = org.hcsoups.hardcore.utils.webutils.ReflectionUtils.PackageType.MINECRAFT_SERVER.getClass(version < 7 ? "Packet63WorldParticles" : "PacketPlayOutWorldParticles");
				packetConstructor = ReflectionUtils.getConstructor(packetClass);
				getHandle = ReflectionUtils.getMethod("CraftPlayer", org.hcsoups.hardcore.utils.webutils.ReflectionUtils.PackageType.CRAFTBUKKIT_ENTITY, "getHandle");
				playerConnection = ReflectionUtils.getField("EntityPlayer", org.hcsoups.hardcore.utils.webutils.ReflectionUtils.PackageType.MINECRAFT_SERVER, false, "playerConnection");
				sendPacket = ReflectionUtils.getMethod(playerConnection.getType(), "sendPacket", org.hcsoups.hardcore.utils.webutils.ReflectionUtils.PackageType.MINECRAFT_SERVER.getClass("Packet"));
